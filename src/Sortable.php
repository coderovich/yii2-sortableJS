...
class Sortable extends Widget {
	...
	protected function registerClientWidget($id)
	{
		...
		$widgetJs .= 'let sortable_'.$id.' = document.getElementById(\''.$id.'\');';
		$widgetJs .= 'new Sortable.create(sortable_'.$id.','.Json::htmlEncode($this->clientOptions).');';
	 ...
	 * @param string $id the ID of the widget
	 * @throws InvalidArgumentException if `$clientEvents` array contains an unsupported event name.
	 */
